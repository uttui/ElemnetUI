<template>
  <div>
    <!-- 基础用法 -->
    <!-- 即使用type、plain、round和circle属性来定义 Button 的样式 -->
    <div>
      <div>基础用法</div>
      <hr />
      <el-row>
    ...
    <div>
      ...
      <br />
      <el-row>
        <el-button round disabled>圆角按钮</el-button>
      ...
      <el-row>
        ...
        <el-button type="danger" icon="el-icon-delete" circledisabled></el-button>
      </el-row>
      <br />
    </div>
    ...
    <!-- 尺寸 -->
    <!-- medium、small、mini，通过设置size属性来配置 -->
    <div>
      <br/>
      <div>尺寸对比</div>
      <hr/>
